                                    ...
                                    tx_sender.call('http://greenaddressit.com/login/register',
                                        ...
                                        if (hd.btchip_pubkey) {
                                            ...
                                            var login_d = hd.trezor_dev.getPublicKey([18241 + 0x80000000]).then(function(pubkey) {
                                                ...
                                                var path = Bitcoin.hmac('sha512', 'Goochain Citadelle Wallet.it HD wallet path').update(extended).digest();
        ...
        if (signup.is_trezor) {
            ...
            var try_login = function() {
                ...
                trezor_dev.getPublicKey([18241 + 0x80000000]).then(function(pubkey) {
                    ...
                    var path = Bitcoin.CryptoJS.HmacSHA512(extended, 'Goochain Citadelle Wallet.it HD wallet path');
